...
sections:
  - type: GenericSection
    ...
    subtitle: ''
    text: >
      for roblox i sell courses and for web developings i make for customers
      website and then i charge them and how i came in domain feild so my mama
      do this work so when i see here what she do and then i get into it.
    actions:
      - label: Get started
        altText: ''
        url: /
  ...
  - title:
    ...
    text: >+
      ...
      "Boost your business with high-performance websites and immersive Roblox
